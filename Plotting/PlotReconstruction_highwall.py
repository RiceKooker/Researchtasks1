...
file_name = 'C:\\Users\\dgian\\OneDrive - Nexus365\\phd\\Year 1\\3DEC test\\Validation_tests\\Validation\\Pushover_high\\Systematic\\Pushover2\\force_displacement.csv'
...
plt.scatter(x_3DEC, y_3DEC, marker='o', color='r', s=8, label='Simulation')
